...
private:
	...
	//anims
	Animation right_idle = Animation();
	Animation left_idle = Animation();
	Animation right_run = Animation();
	Animation left_run = Animation();
	Animation right_jump = Animation();
	Animation left_jump = Animation();
	Animation right_death_blink = Animation();
	Animation left_death_blink = Animation();
	Animation right_shoot = Animation();
	Animation left_shoot = Animation();
